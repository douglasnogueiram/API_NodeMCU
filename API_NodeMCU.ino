...
//Fixar IP
#define IP "192.168.15.21"
#define GATEWAY "192.168.15.1"
...
void config_rest_server_routing() {
  ...
  http_rest_server.on("/", HTTP_GET, []() {
    ...
    html += "<p>GPIO: (preencher como \"gpio\"): indicar qual GPIO voc&ecirc; deseja utilizar entre as dispon&iacute;veis (2,4,5,12,13,15,16). Outros valores n&atilde;o s&atilde;o aceitos (a 14 foi reservada para acionamento do Ar Condicionado)!</p>";
    ...
    html += "</ul>";
    html += "<p>Ao informar o endere&ccedil;o local (http://";
    html += ip;
    html += "/leds), a API ir&aacute; mostrar a lista de GPIOs criadas com sua parametriza&ccedil;&atilde;o atual:</p>";
    html += "<p>JSON de response:</p>";
    html += "<p>[<br />{<br />\"id\": 1,<br />\"gpio\": 2,<br /> \"pinMod\": \"OUTPUT\",<br /> \"status\": 1<br /> },<br /> {<br /> \"id\": 2,<br /> \"gpio\": 4,<br /> \"pinMod\": \"OUTPUT\",<br /> \"status\": 1<br /> }<br />]</p>";
    html += "<p>&nbsp;</p>";
    html += "<p>J&aacute; quando &eacute; passado o par&acirc;metro id&nbsp;&nbsp;(http://";
    html += ip;
    html += "/leds?id=1), ele retorna apenas o elemento consultado, caso exista:</p>";
    html += "<p>C&oacute;digos de resposta:</p>";
    ...
    html += "</table>";
    html += "<p>&nbsp;</p>";
    html += "<p>Douglas Melo - 05/2020 - douglasnogueiram@gmail.com</body></html>";
